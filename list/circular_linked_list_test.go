...
func TestCircularLinkedList(t *testing.T) {
	...
	t.Run("InsertStart", func(t *testing.T) {
		t.Run("should add elements at the beginning of the list", func(t *testing.T) {
			var list list.CircularLinkedList[int]
	...
	t.Run("RemoveStart", func(t *testing.T) {
		...
		t.Run("in an 1-element list", func(t *testing.T) {
			makeList := func() list.CircularLinkedList[int] {
				var list list.CircularLinkedList[int]
				list.InsertEnd(5)
				return list
			}
	...
	t.Run("Find", func(t *testing.T) {
		...
		t.Run("should return the index of the first element", func(t *testing.T) {
			var list list.CircularLinkedList[int]
			list.InsertEnd(1)
			list.InsertEnd(2)
			list.InsertEnd(3)
			...
			index, err := list.Find(1)

			assert.Nil(t, err)
			assert.Equal(t, 0, index)
		})

		t.Run("should return the index of the last element", func(t *testing.T) {
			var list list.CircularLinkedList[int]
			list.InsertEnd(1)
			list.InsertEnd(2)
			list.InsertEnd(3)
